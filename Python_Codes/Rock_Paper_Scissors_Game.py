...
while comp < 5 and user < 5:
    entry = input(Fore.YELLOW + "Enter your choice (rock or 0, paper or 1, scissors or 2): ")
    ...
    if entry in [var1, var2, var3, var4, var5, var6]:
        ...
        if (comp_choice == var1 and (entry == var1 or entry == var4)) or (comp_choice == var2 and (entry == var2 or entry == var5) ) or (comp_choice == var3 and (entry == var3 or entry == var6)):
            time.sleep(1)
            print(Fore.BLUE + "draw")
            time.sleep(1)
            print(Fore.CYAN + f"your score = {user} and comp score = {comp}")
            time.sleep(1)
        elif (comp_choice == var1 and (entry == var2 or entry == var5)) or (comp_choice == var2 and (entry == var3 or entry == var6)) or (comp_choice == var3 and (entry == var1 or entry == var4)):
            user = user + 1
            time.sleep(1)
            ...
            print(Fore.CYAN + f"your score = {user} and comp score = {comp}")
            time.sleep(1)
        elif (comp_choice == var1 and (entry == var3 or entry == var6)) or (comp_choice == var2 and (entry == var1 or entry == var4)) or (comp_choice == var3 and (entry == var2 or entry == var5)):
            comp = comp + 1
            time.sleep(1)
