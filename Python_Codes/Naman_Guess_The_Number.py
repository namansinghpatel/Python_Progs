...
def Guess_The_Number():
    ...
    while True:
        try:
            ...
            if user_guess == 111:
                print(Fore.MAGENTA + "Thankyou for playing, please play once again, have fun :) :-)")
                break 
            ...
            if user_guess < number_to_guess:
                ...
                print(Fore.BLUE + Back.WHITE + f"Congratulations! You guessed the number {number_to_guess} in {attempts} attempts.", end='')
                print(Style.RESET_ALL)
                break
        except:
            print(Fore.RED + Back.YELLOW + "This is not a valid integer, try again !", end = '')
            print(Style.RESET_ALL)
